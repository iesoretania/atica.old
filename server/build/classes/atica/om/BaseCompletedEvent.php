...
/**
 * Base class that represents a row from the 'completed_event' table.
 *
 *
 *
 * @package    propel.generator.atica.om
 */
abstract class BaseCompletedEvent extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CompletedEventPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CompletedEventPeer
     */
     ...
     */
    public function getCompletedDate($format = '%x')
    {
        if ($this->completed_date === null) {
            return null;
        }

        if ($this->completed_date === '0000-00-00') {
     ...
     * @return CompletedEvent The current object (for fluent API support)
     */
    public function setEventId($v)
    {
        ...
        if ($this->event_id !== $v) {
            $this->event_id = $v;
            $this->modifiedColumns[] = CompletedEventPeer::EVENT_ID;
        }
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = CompletedEventPeer::PERSON_ID;
        }
    ...
    public function setCompletedDate($v)
    {
        ...
        if ($this->completed_date !== null || $dt !== null) {
            $currentDateAsString = ($this->completed_date !== null && $tmpDt = new DateTime($this->completed_date)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->completed_date = $newDateAsString;
                $this->modifiedColumns[] = CompletedEventPeer::COMPLETED_DATE;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->completed_date = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = CompletedEventPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CompletedEvent object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CompletedEventPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CompletedEventQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CompletedEventPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CompletedEventPeer::EVENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`EVENT_ID`';
        }
        if ($this->isColumnModified(CompletedEventPeer::PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PERSON_ID`';
        }
        if ($this->isColumnModified(CompletedEventPeer::COMPLETED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`COMPLETED_DATE`';
        }

        $sql = sprintf(
            'INSERT INTO `completed_event` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`PERSON_ID`':
                        ...
                        break;
                    case '`COMPLETED_DATE`':
                        $stmt->bindValue($identifier, $this->completed_date, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CompletedEventPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CompletedEventPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CompletedEvent'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CompletedEvent'][serialize($this->getPrimaryKey())] = true;
        $keys = CompletedEventPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getEventId(),
            $keys[1] => $this->getPersonId(),
            $keys[2] => $this->getCompletedDate(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setCompletedDate($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CompletedEventPeer::EVENT_ID)) $criteria->add(CompletedEventPeer::EVENT_ID, $this->event_id);
        if ($this->isColumnModified(CompletedEventPeer::PERSON_ID)) $criteria->add(CompletedEventPeer::PERSON_ID, $this->person_id);
        if ($this->isColumnModified(CompletedEventPeer::COMPLETED_DATE)) $criteria->add(CompletedEventPeer::COMPLETED_DATE, $this->completed_date);
    ...
    {
        $criteria = new Criteria(CompletedEventPeer::DATABASE_NAME);
        $criteria->add(CompletedEventPeer::EVENT_ID, $this->event_id);
        $criteria->add(CompletedEventPeer::PERSON_ID, $this->person_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getEventId()) && (null === $this->getPersonId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of CompletedEvent (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CompletedEvent Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CompletedEventPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CompletedEventPeer();
        }
    ...
    public function getEvent(PropelPDO $con = null)
    {
        if ($this->aEvent === null && ($this->event_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEvent->addCompletedEvents($this);
             */
        }
    ...
    public function getPerson(PropelPDO $con = null)
    {
        if ($this->aPerson === null && ($this->person_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPerson->addCompletedEvents($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CompletedEventPeer::DEFAULT_STRING_FORMAT);
    }
