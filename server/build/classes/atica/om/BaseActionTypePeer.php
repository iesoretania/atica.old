...
abstract class BaseActionTypePeer
{
    ...
    const DISPLAY_NAME = 'action_type.DISPLAY_NAME';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'action_type.DESCRIPTION';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ActionTypePeer::ID, ActionTypePeer::DISPLAY_NAME, ActionTypePeer::DESCRIPTION, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ActionTypePeer::ID => 0, ActionTypePeer::DISPLAY_NAME => 1, ActionTypePeer::DESCRIPTION => 2, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ActionTypePeer::DISPLAY_NAME);
            $criteria->addSelectColumn(ActionTypePeer::DESCRIPTION);
        } else {
    ...
    /**
     * Deletes all rows from the action_type table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
