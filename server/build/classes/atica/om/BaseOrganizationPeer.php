...
abstract class BaseOrganizationPeer
{
    ...
    const DISPLAY_NAME = 'organization.DISPLAY_NAME';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'DisplayName', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'displayName', ),
        BasePeer::TYPE_COLNAME => array (OrganizationPeer::ID, OrganizationPeer::DISPLAY_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DISPLAY_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'display_name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'DisplayName' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'displayName' => 1, ),
        BasePeer::TYPE_COLNAME => array (OrganizationPeer::ID => 0, OrganizationPeer::DISPLAY_NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DISPLAY_NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'display_name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrganizationPeer::DISPLAY_NAME);
        } else {
    ...
    {
        // Invalidate objects in SnapshotPeer instance pool,
