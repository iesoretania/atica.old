...
/**
 * Base class that represents a row from the 'grouping_profile_group' table.
 *
 *
 *
 * @package    propel.generator.atica.om
 */
abstract class BaseGroupingProfileGroup extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'GroupingProfileGroupPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GroupingProfileGroupPeer
     */
     ...
     * @return GroupingProfileGroup The current object (for fluent API support)
     */
    public function setGroupingId($v)
    {
        ...
        if ($this->grouping_id !== $v) {
            $this->grouping_id = $v;
            $this->modifiedColumns[] = GroupingProfileGroupPeer::GROUPING_ID;
        }
    ...
    public function setProfileGroupId($v)
    {
        ...
        if ($this->profile_group_id !== $v) {
            ...
            $this->modifiedColumns[] = GroupingProfileGroupPeer::PROFILE_GROUP_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = GroupingProfileGroupPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GroupingProfileGroup object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GroupingProfileGroupPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GroupingProfileGroupQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GroupingProfileGroupPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GroupingProfileGroupPeer::GROUPING_ID)) {
            $modifiedColumns[':p' . $index++]  = '`GROUPING_ID`';
        }
        if ($this->isColumnModified(GroupingProfileGroupPeer::PROFILE_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PROFILE_GROUP_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `grouping_profile_group` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GroupingProfileGroupPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GroupingProfileGroupPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GroupingProfileGroup'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GroupingProfileGroup'][serialize($this->getPrimaryKey())] = true;
        $keys = GroupingProfileGroupPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupingProfileGroupPeer::GROUPING_ID)) $criteria->add(GroupingProfileGroupPeer::GROUPING_ID, $this->grouping_id);
        if ($this->isColumnModified(GroupingProfileGroupPeer::PROFILE_GROUP_ID)) $criteria->add(GroupingProfileGroupPeer::PROFILE_GROUP_ID, $this->profile_group_id);
    ...
    {
        $criteria = new Criteria(GroupingProfileGroupPeer::DATABASE_NAME);
        $criteria->add(GroupingProfileGroupPeer::GROUPING_ID, $this->grouping_id);
        $criteria->add(GroupingProfileGroupPeer::PROFILE_GROUP_ID, $this->profile_group_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getGroupingId()) && (null === $this->getProfileGroupId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of GroupingProfileGroup (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GroupingProfileGroup Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GroupingProfileGroupPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GroupingProfileGroupPeer();
        }
    ...
    public function setProfileGroup(ProfileGroup $v = null)
    {
        ...
        if ($v !== null) {
            $v->addGroupingProfileGroup($this);
        }
    ...
    public function getProfileGroup(PropelPDO $con = null)
    {
        if ($this->aProfileGroup === null && ($this->profile_group_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProfileGroup->addGroupingProfileGroups($this);
             */
        }
    ...
    public function getGrouping(PropelPDO $con = null)
    {
        if ($this->aGrouping === null && ($this->grouping_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGrouping->addGroupingProfileGroups($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(GroupingProfileGroupPeer::DEFAULT_STRING_FORMAT);
    }
