...
abstract class BaseProfilePeer
{
    ...
    const PROFILE_GROUP_ID = 'profile.PROFILE_GROUP_ID';

    /** the column name for the ORDER_NR field */
    const ORDER_NR = 'profile.ORDER_NR';
     ...
     * rank column
     */
    const RANK_COL = 'profile.ORDER_NR';

    /**
     * Scope column for the set
     */
    const SCOPE_COL = 'profile.PROFILE_GROUP_ID';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ProfileGroupId', 'OrderNr', 'DisplayName', 'Description', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'profileGroupId', 'orderNr', 'displayName', 'description', ),
        BasePeer::TYPE_COLNAME => array (ProfilePeer::ID, ProfilePeer::PROFILE_GROUP_ID, ProfilePeer::ORDER_NR, ProfilePeer::DISPLAY_NAME, ProfilePeer::DESCRIPTION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PROFILE_GROUP_ID', 'ORDER_NR', 'DISPLAY_NAME', 'DESCRIPTION', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'profile_group_id', 'order_nr', 'display_name', 'description', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ProfileGroupId' => 1, 'OrderNr' => 2, 'DisplayName' => 3, 'Description' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'profileGroupId' => 1, 'orderNr' => 2, 'displayName' => 3, 'description' => 4, ),
        BasePeer::TYPE_COLNAME => array (ProfilePeer::ID => 0, ProfilePeer::PROFILE_GROUP_ID => 1, ProfilePeer::ORDER_NR => 2, ProfilePeer::DISPLAY_NAME => 3, ProfilePeer::DESCRIPTION => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PROFILE_GROUP_ID' => 1, 'ORDER_NR' => 2, 'DISPLAY_NAME' => 3, 'DESCRIPTION' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'profile_group_id' => 1, 'order_nr' => 2, 'display_name' => 3, 'description' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProfilePeer::PROFILE_GROUP_ID);
            $criteria->addSelectColumn(ProfilePeer::ORDER_NR);
            $criteria->addSelectColumn(ProfilePeer::DISPLAY_NAME);
    ...
    public static function doCountJoinProfileGroup(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ProfilePeer::PROFILE_GROUP_ID, ProfileGroupPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Profile objects pre-filled with their ProfileGroup objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinProfileGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Profile) to $obj2 (ProfileGroup)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Profile) to the collection in $obj2 (ProfileGroup)
                $obj2->addProfile($obj1);
    ...
    public static function getMaxRank($scope = null, PropelPDO $con = null)
    {
        ...
        $c = new Criteria();
        $c->addSelectColumn('MAX(' . ProfilePeer::RANK_COL . ')');
        $c->add(ProfilePeer::SCOPE_COL, $scope, Criteria::EQUAL);
        $stmt = ProfilePeer::doSelectStmt($c, $con);
    ...
    public static function retrieveByRank($rank, $scope = null, PropelPDO $con = null)
    {
        ...
        $c = new Criteria;
        $c->add(ProfilePeer::RANK_COL, $rank);
        $c->add(ProfilePeer::SCOPE_COL, $scope, Criteria::EQUAL);

        return ProfilePeer::doSelectOne($c, $con);
    }
    ...
    public static function reorder(array $order, PropelPDO $con = null)
    {
        ...
        try {
            ...
            $objects = ProfilePeer::retrieveByPKs($ids);
    ...
    public static function doSelectOrderByRank(Criteria $criteria = null, $order = Criteria::ASC, PropelPDO $con = null)
    {
        ...
        if ($order == Criteria::ASC) {
            $criteria->addAscendingOrderByColumn(ProfilePeer::RANK_COL);
        } else {
            $criteria->addDescendingOrderByColumn(ProfilePeer::RANK_COL);
        }

        return ProfilePeer::doSelect($criteria, $con);
    }
    ...
    {
        $c = new Criteria();
        $c->add(ProfilePeer::SCOPE_COL, $scope);

        return ProfilePeer::doSelectOrderByRank($c, $order, $con);
    }
    ...
    public static function countList($scope, PropelPDO $con = null)
    {
        ...
        return ProfilePeer::doCount($c, $con);
    }
    ...
    public static function deleteList($scope, PropelPDO $con = null)
    {
        ...
        return ProfilePeer::doDelete($c, $con);
    }
    ...
    public static function shiftRank($delta, $first, $last = null, $scope = null, PropelPDO $con = null)
    {
        ...
        $whereCriteria = new Criteria(ProfilePeer::DATABASE_NAME);
        $criterion = $whereCriteria->getNewCriterion(ProfilePeer::RANK_COL, $first, Criteria::GREATER_EQUAL);
        if (null !== $last) {
            $criterion->addAnd($whereCriteria->getNewCriterion(ProfilePeer::RANK_COL, $last, Criteria::LESS_EQUAL));
        }
        $whereCriteria->add($criterion);
        $whereCriteria->add(ProfilePeer::SCOPE_COL, $scope, Criteria::EQUAL);

        $valuesCriteria = new Criteria(ProfilePeer::DATABASE_NAME);
        $valuesCriteria->add(ProfilePeer::RANK_COL, array('raw' => ProfilePeer::RANK_COL . ' + ?', 'value' => $delta), Criteria::CUSTOM_EQUAL);
