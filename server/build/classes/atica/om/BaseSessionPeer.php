...
abstract class BaseSessionPeer
{
    ...
    const PERSON_ID = 'session.PERSON_ID';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'PersonId', 'OrganizationId', 'Expiration', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'personId', 'organizationId', 'expiration', ),
        BasePeer::TYPE_COLNAME => array (SessionPeer::ID, SessionPeer::PERSON_ID, SessionPeer::ORGANIZATION_ID, SessionPeer::EXPIRATION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PERSON_ID', 'ORGANIZATION_ID', 'EXPIRATION', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'person_id', 'organization_id', 'expiration', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PersonId' => 1, 'OrganizationId' => 2, 'Expiration' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'personId' => 1, 'organizationId' => 2, 'expiration' => 3, ),
        BasePeer::TYPE_COLNAME => array (SessionPeer::ID => 0, SessionPeer::PERSON_ID => 1, SessionPeer::ORGANIZATION_ID => 2, SessionPeer::EXPIRATION => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PERSON_ID' => 1, 'ORGANIZATION_ID' => 2, 'EXPIRATION' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'person_id' => 1, 'organization_id' => 2, 'expiration' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SessionPeer::PERSON_ID);
            $criteria->addSelectColumn(SessionPeer::ORGANIZATION_ID);
            $criteria->addSelectColumn(SessionPeer::EXPIRATION);
        } else {
    ...
    public static function doCountJoinPerson(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(SessionPeer::PERSON_ID, PersonPeer::ID, $join_behavior);
    ...
    public static function doCountJoinOrganization(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(SessionPeer::ORGANIZATION_ID, OrganizationPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Session objects pre-filled with their Person objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinPerson(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Session) to $obj2 (Person)
    ...
    /**
     * Selects a collection of Session objects pre-filled with their Organization objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Session objects.
    ...
    public static function doSelectJoinOrganization(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Session) to $obj2 (Organization)
                $obj2->addSession($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Session) to the collection in $obj2 (Person)
                $obj2->addSession($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Session) to the collection in $obj3 (Organization)
    ...
    /**
     * Selects a collection of Session objects pre-filled with all related objects except Person.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptPerson(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = SessionPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Session) to the collection in $obj2 (Organization)
                $obj2->addSession($obj1);
    ...
    /**
     * Selects a collection of Session objects pre-filled with all related objects except Organization.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(SessionPeer::PERSON_ID);
            $value = $criteria->remove(SessionPeer::PERSON_ID);
            if ($value) {
                $selectCriteria->add(SessionPeer::PERSON_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(SessionPeer::TABLE_NAME);
            }
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(SessionPeer::ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(SessionPeer::PERSON_ID, $value[1]));
                $criteria->addOr($criterion);
                // we can invalidate the cache for this single PK
                SessionPeer::removeInstanceFromPool($value);
            }
        }
    ...
    public static function retrieveByPK($id, $person_id, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $id, (string) $person_id));
         if (null !== ($obj = SessionPeer::getInstanceFromPool($_instancePoolKey))) {
             return $obj;
        }
        ...
        $criteria = new Criteria(SessionPeer::DATABASE_NAME);
        $criteria->add(SessionPeer::ID, $id);
        $criteria->add(SessionPeer::PERSON_ID, $person_id);
