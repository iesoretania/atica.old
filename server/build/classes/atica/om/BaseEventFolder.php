...
/**
 * Base class that represents a row from the 'event_folder' table.
 *
 *
 *
 * @package    propel.generator.atica.om
 */
abstract class BaseEventFolder extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'EventFolderPeer';
    ...
    /**
     * Initializes internal state of BaseEventFolder object.
     * @see        applyDefaults()
     */
     ...
     * @return EventFolder The current object (for fluent API support)
     */
    public function setEventId($v)
    {
        ...
        if ($this->event_id !== $v) {
            $this->event_id = $v;
            $this->modifiedColumns[] = EventFolderPeer::EVENT_ID;
        }
    ...
    public function setFolderId($v)
    {
        ...
        if ($this->folder_id !== $v) {
            $this->folder_id = $v;
            $this->modifiedColumns[] = EventFolderPeer::FOLDER_ID;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = EventFolderPeer::DESCRIPTION;
        }
    ...
    public function setIsMandatory($v)
    {
        ...
        if ($this->is_mandatory !== $v) {
            $this->is_mandatory = $v;
            $this->modifiedColumns[] = EventFolderPeer::IS_MANDATORY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->is_mandatory = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = EventFolderPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating EventFolder object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EventFolderPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EventFolderQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EventFolderPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EventFolderPeer::EVENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`EVENT_ID`';
        }
        if ($this->isColumnModified(EventFolderPeer::FOLDER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`FOLDER_ID`';
        }
        if ($this->isColumnModified(EventFolderPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPTION`';
        }
        if ($this->isColumnModified(EventFolderPeer::IS_MANDATORY)) {
            $modifiedColumns[':p' . $index++]  = '`IS_MANDATORY`';
        }

        $sql = sprintf(
            'INSERT INTO `event_folder` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`DESCRIPTION`':
                        ...
                        break;
                    case '`IS_MANDATORY`':
                        $stmt->bindValue($identifier, (int) $this->is_mandatory, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EventFolderPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EventFolderPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['EventFolder'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EventFolder'][serialize($this->getPrimaryKey())] = true;
        $keys = EventFolderPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getEventId(),
            $keys[1] => $this->getFolderId(),
            $keys[2] => $this->getDescription(),
            $keys[3] => $this->getIsMandatory(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setIsMandatory($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventFolderPeer::EVENT_ID)) $criteria->add(EventFolderPeer::EVENT_ID, $this->event_id);
        if ($this->isColumnModified(EventFolderPeer::FOLDER_ID)) $criteria->add(EventFolderPeer::FOLDER_ID, $this->folder_id);
        if ($this->isColumnModified(EventFolderPeer::DESCRIPTION)) $criteria->add(EventFolderPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(EventFolderPeer::IS_MANDATORY)) $criteria->add(EventFolderPeer::IS_MANDATORY, $this->is_mandatory);
    ...
    {
        $criteria = new Criteria(EventFolderPeer::DATABASE_NAME);
        $criteria->add(EventFolderPeer::EVENT_ID, $this->event_id);
        $criteria->add(EventFolderPeer::FOLDER_ID, $this->folder_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getEventId()) && (null === $this->getFolderId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of EventFolder (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EventFolder Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EventFolderPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EventFolderPeer();
        }
    ...
    public function getEvent(PropelPDO $con = null)
    {
        if ($this->aEvent === null && ($this->event_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEvent->addEventFolders($this);
             */
        }
    ...
    public function getFolder(PropelPDO $con = null)
    {
        if ($this->aFolder === null && ($this->folder_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aFolder->addEventFolders($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(EventFolderPeer::DEFAULT_STRING_FORMAT);
    }
