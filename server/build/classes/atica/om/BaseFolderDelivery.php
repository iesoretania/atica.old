...
/**
 * Base class that represents a row from the 'folder_delivery' table.
 *
 *
 *
 * @package    propel.generator.atica.om
 */
abstract class BaseFolderDelivery extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'FolderDeliveryPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FolderDeliveryPeer
     */
     ...
     * @return FolderDelivery The current object (for fluent API support)
     */
    public function setFolderId($v)
    {
        ...
        if ($this->folder_id !== $v) {
            // sortable behavior
            $this->oldScope = $this->getFolderId();

            $this->folder_id = $v;
            $this->modifiedColumns[] = FolderDeliveryPeer::FOLDER_ID;
        }
    ...
    public function setDeliveryId($v)
    {
        ...
        if ($this->delivery_id !== $v) {
            $this->delivery_id = $v;
            $this->modifiedColumns[] = FolderDeliveryPeer::DELIVERY_ID;
        }
    ...
    public function setOrderNr($v)
    {
        ...
        if ($this->order_nr !== $v) {
            $this->order_nr = $v;
            $this->modifiedColumns[] = FolderDeliveryPeer::ORDER_NR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = FolderDeliveryPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FolderDelivery object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FolderDeliveryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FolderDeliveryQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // sortable behavior

            FolderDeliveryPeer::shiftRank(-1, $this->getOrderNr() + 1, null, $this->getFolderId(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // sortable behavior
                if (!$this->isColumnModified(FolderDeliveryPeer::RANK_COL)) {
                    $this->setOrderNr(FolderDeliveryQuery::create()->getMaxRank($this->getFolderId(), $con) + 1);
                }
                ...
                if ($this->isColumnModified(FolderDeliveryPeer::SCOPE_COL) && !$this->isColumnModified(FolderDeliveryPeer::RANK_COL)) {
                    FolderDeliveryPeer::shiftRank(-1, $this->getOrderNr() + 1, null, $this->oldScope, $con);
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FolderDeliveryPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FolderDeliveryPeer::FOLDER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`FOLDER_ID`';
        }
        if ($this->isColumnModified(FolderDeliveryPeer::DELIVERY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`DELIVERY_ID`';
        }
        if ($this->isColumnModified(FolderDeliveryPeer::ORDER_NR)) {
            $modifiedColumns[':p' . $index++]  = '`ORDER_NR`';
        }

        $sql = sprintf(
            'INSERT INTO `folder_delivery` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FolderDeliveryPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FolderDeliveryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['FolderDelivery'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FolderDelivery'][serialize($this->getPrimaryKey())] = true;
        $keys = FolderDeliveryPeer::getFieldNames($keyType);
        $result = array(
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aDelivery) {
                $result['Delivery'] = $this->aDelivery->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FolderDeliveryPeer::FOLDER_ID)) $criteria->add(FolderDeliveryPeer::FOLDER_ID, $this->folder_id);
        if ($this->isColumnModified(FolderDeliveryPeer::DELIVERY_ID)) $criteria->add(FolderDeliveryPeer::DELIVERY_ID, $this->delivery_id);
        if ($this->isColumnModified(FolderDeliveryPeer::ORDER_NR)) $criteria->add(FolderDeliveryPeer::ORDER_NR, $this->order_nr);
    ...
    {
        $criteria = new Criteria(FolderDeliveryPeer::DATABASE_NAME);
        $criteria->add(FolderDeliveryPeer::FOLDER_ID, $this->folder_id);
        $criteria->add(FolderDeliveryPeer::DELIVERY_ID, $this->delivery_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getFolderId()) && (null === $this->getDeliveryId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of FolderDelivery (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FolderDelivery Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FolderDeliveryPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FolderDeliveryPeer();
        }
    ...
    public function getFolder(PropelPDO $con = null)
    {
        if ($this->aFolder === null && ($this->folder_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFolder->addFolderDeliveries($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setDelivery(Delivery $v = null)
    {
        if ($v === null) {
     ...
     * @throws PropelException
     */
    public function getDelivery(PropelPDO $con = null)
    {
        if ($this->aDelivery === null && ($this->delivery_id !== null)) {
            $this->aDelivery = DeliveryQuery::create()->findPk($this->delivery_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDelivery->addFolderDeliveries($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(FolderDeliveryPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    {
        return $this->getOrderNr() == FolderDeliveryQuery::create()->getMaxRank($this->getFolderId(), $con);
    }
    ...
    public function getNext(PropelPDO $con = null)
    {
        ...
        return FolderDeliveryQuery::create()->findOneByRank($this->getOrderNr() + 1, $this->getFolderId(), $con);
    }
     ...
     * @param     PropelPDO  $con      optional connection
     *
     * @return    FolderDelivery the current object
     *
     * @throws    PropelException
     */
    public function insertAtRank($rank, PropelPDO $con = null)
    {
        $maxRank = FolderDeliveryQuery::create()->getMaxRank($this->getFolderId(), $con);
        ...
        if ($rank != $maxRank + 1) {
            ...
            $this->sortableQueries []= array(
                ...
                'arguments' => array(1, $rank, null, $this->getFolderId())
            );
        }
    ...
    public function moveToRank($newRank, PropelPDO $con = null)
    {
        ...
        if ($newRank < 1 || $newRank > FolderDeliveryQuery::create()->getMaxRank($this->getFolderId(), $con)) {
        ...
        try {
            ...
            FolderDeliveryPeer::shiftRank($delta, min($oldRank, $newRank), max($oldRank, $newRank), $this->getFolderId(), $con);
    ...
    public function swapWith($object, PropelPDO $con = null)
    {
        ...
        $con->beginTransaction();
        try {
            $oldScope = $this->getFolderId();
            $newScope = $object->getFolderId();
            if ($oldScope != $newScope) {
                $this->setFolderId($newScope);
                $object->setFolderId($oldScope);
            }
            $oldRank = $this->getOrderNr();
    ...
    public function moveToBottom(PropelPDO $con = null)
    {
        ...
        $con->beginTransaction();
        try {
            $bottom = FolderDeliveryQuery::create()->getMaxRank($this->getFolderId(), $con);
