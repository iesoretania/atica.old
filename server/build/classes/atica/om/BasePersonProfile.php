...
/**
 * Base class that represents a row from the 'person_profile' table.
 *
 *
 *
 * @package    propel.generator.atica.om
 */
abstract class BasePersonProfile extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PersonProfilePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PersonProfilePeer
     */
     ...
     * @return PersonProfile The current object (for fluent API support)
     */
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = PersonProfilePeer::PERSON_ID;
        }
    ...
    public function setProfileId($v)
    {
        ...
        if ($this->profile_id !== $v) {
            $this->profile_id = $v;
            $this->modifiedColumns[] = PersonProfilePeer::PROFILE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = PersonProfilePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PersonProfile object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PersonProfilePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PersonProfileQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PersonProfilePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PersonProfilePeer::PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PERSON_ID`';
        }
        if ($this->isColumnModified(PersonProfilePeer::PROFILE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PROFILE_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `person_profile` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PersonProfilePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PersonProfilePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PersonProfile'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PersonProfile'][serialize($this->getPrimaryKey())] = true;
        $keys = PersonProfilePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PersonProfilePeer::PERSON_ID)) $criteria->add(PersonProfilePeer::PERSON_ID, $this->person_id);
        if ($this->isColumnModified(PersonProfilePeer::PROFILE_ID)) $criteria->add(PersonProfilePeer::PROFILE_ID, $this->profile_id);
    ...
    {
        $criteria = new Criteria(PersonProfilePeer::DATABASE_NAME);
        $criteria->add(PersonProfilePeer::PERSON_ID, $this->person_id);
        $criteria->add(PersonProfilePeer::PROFILE_ID, $this->profile_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getPersonId()) && (null === $this->getProfileId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of PersonProfile (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PersonProfile Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PersonProfilePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PersonProfilePeer();
        }
    ...
    public function getProfile(PropelPDO $con = null)
    {
        if ($this->aProfile === null && ($this->profile_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProfile->addPersonProfiles($this);
             */
        }
    ...
    public function getPerson(PropelPDO $con = null)
    {
        if ($this->aPerson === null && ($this->person_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPerson->addPersonProfiles($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PersonProfilePeer::DEFAULT_STRING_FORMAT);
    }
