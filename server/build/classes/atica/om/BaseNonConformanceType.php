...
/**
 * Base class that represents a row from the 'non_conformance_type' table.
 *
 *
 *
 * @package    propel.generator.atica.om
 */
abstract class BaseNonConformanceType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'NonConformanceTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        NonConformanceTypePeer
     */
     ...
     * @return NonConformanceType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = NonConformanceTypePeer::ID;
        }
    ...
    public function setDisplayName($v)
    {
        ...
        if ($this->display_name !== $v) {
            $this->display_name = $v;
            $this->modifiedColumns[] = NonConformanceTypePeer::DISPLAY_NAME;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = NonConformanceTypePeer::DESCRIPTION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = NonConformanceTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating NonConformanceType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = NonConformanceTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = NonConformanceTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                NonConformanceTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NonConformanceTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(NonConformanceTypePeer::DISPLAY_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`DISPLAY_NAME`';
        }
        if ($this->isColumnModified(NonConformanceTypePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPTION`';
        }

        $sql = sprintf(
            'INSERT INTO `non_conformance_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = NonConformanceTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = NonConformanceTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['NonConformanceType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['NonConformanceType'][$this->getPrimaryKey()] = true;
        $keys = NonConformanceTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NonConformanceTypePeer::ID)) $criteria->add(NonConformanceTypePeer::ID, $this->id);
        if ($this->isColumnModified(NonConformanceTypePeer::DISPLAY_NAME)) $criteria->add(NonConformanceTypePeer::DISPLAY_NAME, $this->display_name);
        if ($this->isColumnModified(NonConformanceTypePeer::DESCRIPTION)) $criteria->add(NonConformanceTypePeer::DESCRIPTION, $this->description);
    ...
    {
        $criteria = new Criteria(NonConformanceTypePeer::DATABASE_NAME);
        $criteria->add(NonConformanceTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of NonConformanceType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return NonConformanceType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return NonConformanceTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new NonConformanceTypePeer();
        }
     ...
     * If this NonConformanceType is new, it will return
        ...
        if (null === $this->collNonConformances || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collNonConformances) {
                ...
                $collNonConformances = NonConformanceQuery::create(null, $criteria)
                    ->filterByNonConformanceType($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setNonConformances(PropelCollection $nonConformances, PropelPDO $con = null)
    {
        ...
        foreach ($this->nonConformancesScheduledForDeletion as $nonConformanceRemoved) {
            $nonConformanceRemoved->setNonConformanceType(null);
        }
    ...
    protected function doAddNonConformance($nonConformance)
    {
        ...
        $nonConformance->setNonConformanceType($this);
    }
    ...
    public function removeNonConformance($nonConformance)
    {
        if ($this->getNonConformances()->contains($nonConformance)) {
            ...
            $nonConformance->setNonConformanceType(null);
        }
    }
     ...
     * Otherwise if this NonConformanceType is new, it will return
     * an empty collection; or if this NonConformanceType has previously
     * been saved, it will retrieve related NonConformances from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in NonConformanceType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|NonConformance[] List of NonConformance objects
     */
    public function getNonConformancesJoinSnapshot($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = NonConformanceQuery::create(null, $criteria);
