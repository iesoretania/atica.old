...
abstract class BaseActivityPeer
{
    ...
    const SNAPSHOT_ID = 'activity.SNAPSHOT_ID';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'SnapshotId', 'DisplayName', 'Description', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'snapshotId', 'displayName', 'description', ),
        BasePeer::TYPE_COLNAME => array (ActivityPeer::ID, ActivityPeer::SNAPSHOT_ID, ActivityPeer::DISPLAY_NAME, ActivityPeer::DESCRIPTION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SNAPSHOT_ID', 'DISPLAY_NAME', 'DESCRIPTION', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'snapshot_id', 'display_name', 'description', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'SnapshotId' => 1, 'DisplayName' => 2, 'Description' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'snapshotId' => 1, 'displayName' => 2, 'description' => 3, ),
        BasePeer::TYPE_COLNAME => array (ActivityPeer::ID => 0, ActivityPeer::SNAPSHOT_ID => 1, ActivityPeer::DISPLAY_NAME => 2, ActivityPeer::DESCRIPTION => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SNAPSHOT_ID' => 1, 'DISPLAY_NAME' => 2, 'DESCRIPTION' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'snapshot_id' => 1, 'display_name' => 2, 'description' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ActivityPeer::SNAPSHOT_ID);
            $criteria->addSelectColumn(ActivityPeer::DISPLAY_NAME);
    ...
    /**
     * Method to invalidate the instance pool of all tables related to activity
    ...
    public static function doCountJoinSnapshot(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ActivityPeer::SNAPSHOT_ID, SnapshotPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Activity objects pre-filled with their Snapshot objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinSnapshot(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        ActivityPeer::addSelectColumns($criteria);
        $startcol = ActivityPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Activity) to $obj2 (Snapshot)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        ActivityPeer::addSelectColumns($criteria);
        $startcol2 = ActivityPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Activity) to the collection in $obj2 (Snapshot)
                $obj2->addActivity($obj1);
