...
/**
 * Base class that represents a row from the 'folder_permission' table.
 *
 *
 *
 * @package    propel.generator.atica.om
 */
abstract class BaseFolderPermission extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'FolderPermissionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FolderPermissionPeer
     */
     ...
     * @return FolderPermission The current object (for fluent API support)
     */
    public function setFolderId($v)
    {
        ...
        if ($this->folder_id !== $v) {
            $this->folder_id = $v;
            $this->modifiedColumns[] = FolderPermissionPeer::FOLDER_ID;
        }
    ...
    public function setProfileGroupId($v)
    {
        ...
        if ($this->profile_group_id !== $v) {
            ...
            $this->modifiedColumns[] = FolderPermissionPeer::PROFILE_GROUP_ID;
        }
    ...
    public function setPermission($v)
    {
        ...
        if ($this->permission !== $v) {
            $this->permission = $v;
            $this->modifiedColumns[] = FolderPermissionPeer::PERMISSION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->permission = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = FolderPermissionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FolderPermission object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FolderPermissionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FolderPermissionQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FolderPermissionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FolderPermissionPeer::FOLDER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`FOLDER_ID`';
        }
        if ($this->isColumnModified(FolderPermissionPeer::PROFILE_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PROFILE_GROUP_ID`';
        }
        if ($this->isColumnModified(FolderPermissionPeer::PERMISSION)) {
            $modifiedColumns[':p' . $index++]  = '`PERMISSION`';
        }

        $sql = sprintf(
            'INSERT INTO `folder_permission` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FolderPermissionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FolderPermissionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['FolderPermission'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FolderPermission'][serialize($this->getPrimaryKey())] = true;
        $keys = FolderPermissionPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setPermission($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FolderPermissionPeer::FOLDER_ID)) $criteria->add(FolderPermissionPeer::FOLDER_ID, $this->folder_id);
        if ($this->isColumnModified(FolderPermissionPeer::PROFILE_GROUP_ID)) $criteria->add(FolderPermissionPeer::PROFILE_GROUP_ID, $this->profile_group_id);
        if ($this->isColumnModified(FolderPermissionPeer::PERMISSION)) $criteria->add(FolderPermissionPeer::PERMISSION, $this->permission);
    ...
    {
        $criteria = new Criteria(FolderPermissionPeer::DATABASE_NAME);
        $criteria->add(FolderPermissionPeer::FOLDER_ID, $this->folder_id);
        $criteria->add(FolderPermissionPeer::PROFILE_GROUP_ID, $this->profile_group_id);
        $criteria->add(FolderPermissionPeer::PERMISSION, $this->permission);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getFolderId()) && (null === $this->getProfileGroupId()) && (null === $this->getPermission());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of FolderPermission (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FolderPermission Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FolderPermissionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FolderPermissionPeer();
        }
    ...
    public function getProfileGroup(PropelPDO $con = null)
    {
        if ($this->aProfileGroup === null && ($this->profile_group_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProfileGroup->addFolderPermissions($this);
             */
        }
    ...
    public function getFolder(PropelPDO $con = null)
    {
        if ($this->aFolder === null && ($this->folder_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aFolder->addFolderPermissions($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(FolderPermissionPeer::DEFAULT_STRING_FORMAT);
    }
