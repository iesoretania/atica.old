...
/**
 * Base class that represents a row from the 'event_profile_group' table.
 *
 *
 *
 * @package    propel.generator.atica.om
 */
abstract class BaseEventProfileGroup extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'EventProfileGroupPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EventProfileGroupPeer
     */
     ...
     * @return EventProfileGroup The current object (for fluent API support)
     */
    public function setEventId($v)
    {
        ...
        if ($this->event_id !== $v) {
            $this->event_id = $v;
            $this->modifiedColumns[] = EventProfileGroupPeer::EVENT_ID;
        }
    ...
    public function setProfileGroupId($v)
    {
        ...
        if ($this->profile_group_id !== $v) {
            ...
            $this->modifiedColumns[] = EventProfileGroupPeer::PROFILE_GROUP_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = EventProfileGroupPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating EventProfileGroup object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EventProfileGroupPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EventProfileGroupQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EventProfileGroupPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EventProfileGroupPeer::EVENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`EVENT_ID`';
        }
        if ($this->isColumnModified(EventProfileGroupPeer::PROFILE_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PROFILE_GROUP_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `event_profile_group` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EventProfileGroupPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EventProfileGroupPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['EventProfileGroup'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EventProfileGroup'][serialize($this->getPrimaryKey())] = true;
        $keys = EventProfileGroupPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventProfileGroupPeer::EVENT_ID)) $criteria->add(EventProfileGroupPeer::EVENT_ID, $this->event_id);
        if ($this->isColumnModified(EventProfileGroupPeer::PROFILE_GROUP_ID)) $criteria->add(EventProfileGroupPeer::PROFILE_GROUP_ID, $this->profile_group_id);
    ...
    {
        $criteria = new Criteria(EventProfileGroupPeer::DATABASE_NAME);
        $criteria->add(EventProfileGroupPeer::EVENT_ID, $this->event_id);
        $criteria->add(EventProfileGroupPeer::PROFILE_GROUP_ID, $this->profile_group_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getEventId()) && (null === $this->getProfileGroupId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of EventProfileGroup (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EventProfileGroup Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EventProfileGroupPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EventProfileGroupPeer();
        }
    ...
    public function getProfileGroup(PropelPDO $con = null)
    {
        if ($this->aProfileGroup === null && ($this->profile_group_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProfileGroup->addEventProfileGroups($this);
             */
        }
    ...
    public function getEvent(PropelPDO $con = null)
    {
        if ($this->aEvent === null && ($this->event_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEvent->addEventProfileGroups($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(EventProfileGroupPeer::DEFAULT_STRING_FORMAT);
    }
