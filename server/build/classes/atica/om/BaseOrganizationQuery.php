 ...
 * @method OrganizationQuery orderByDisplayName($order = Criteria::ASC) Order by the display_name column
 *
 * @method OrganizationQuery groupById() Group by the id column
 * @method OrganizationQuery groupByDisplayName() Group by the display_name column
 *
 ...
 *
 * @method OrganizationQuery leftJoinSnapshot($relationAlias = null) Adds a LEFT JOIN clause to the query using the Snapshot relation
 * @method OrganizationQuery rightJoinSnapshot($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Snapshot relation
 * @method OrganizationQuery innerJoinSnapshot($relationAlias = null) Adds a INNER JOIN clause to the query using the Snapshot relation
 *
 * @method OrganizationQuery leftJoinConfiguration($relationAlias = null) Adds a LEFT JOIN clause to the query using the Configuration relation
 * @method OrganizationQuery rightJoinConfiguration($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Configuration relation
 * @method OrganizationQuery innerJoinConfiguration($relationAlias = null) Adds a INNER JOIN clause to the query using the Configuration relation
 *
 * @method OrganizationQuery leftJoinPersonOrganization($relationAlias = null) Adds a LEFT JOIN clause to the query using the PersonOrganization relation
 * @method OrganizationQuery rightJoinPersonOrganization($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PersonOrganization relation
 * @method OrganizationQuery innerJoinPersonOrganization($relationAlias = null) Adds a INNER JOIN clause to the query using the PersonOrganization relation
 *
 * @method OrganizationQuery leftJoinSession($relationAlias = null) Adds a LEFT JOIN clause to the query using the Session relation
 * @method OrganizationQuery rightJoinSession($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Session relation
 * @method OrganizationQuery innerJoinSession($relationAlias = null) Adds a INNER JOIN clause to the query using the Session relation
 *
 ...
 *
 * @method Organization findOneByDisplayName(string $display_name) Return the first Organization filtered by the display_name column
 *
 * @method array findById(int $id) Return Organization objects filtered by the id column
 * @method array findByDisplayName(string $display_name) Return Organization objects filtered by the display_name column
 *
...
abstract class BaseOrganizationQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'atica', $modelName = 'Organization', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `ID`, `DISPLAY_NAME` FROM `organization` WHERE `ID` = :p0';
        try {
    ...
    public function filterByDisplayName($displayName = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(OrganizationPeer::DISPLAY_NAME, $displayName, $comparison);
    }

    /**
     * Filter the query by a related Snapshot object
     *
     * @param   Snapshot|PropelObjectCollection $snapshot  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   OrganizationQuery The current query, for fluid interface
    ...
    public function filterBySnapshot($snapshot, $comparison = null)
    {
        if ($snapshot instanceof Snapshot) {
            return $this
                ->addUsingAlias(OrganizationPeer::ID, $snapshot->getOrganizationId(), $comparison);
        } elseif ($snapshot instanceof PropelObjectCollection) {
            return $this
                ->useSnapshotQuery()
                ->filterByPrimaryKeys($snapshot->getPrimaryKeys())
                ->endUse();
        } else {
    ...
    public function filterByConfiguration($configuration, $comparison = null)
    {
        if ($configuration instanceof Configuration) {
            return $this
                ->addUsingAlias(OrganizationPeer::ID, $configuration->getOrganizationId(), $comparison);
    ...
    public function filterByPersonOrganization($personOrganization, $comparison = null)
    {
        if ($personOrganization instanceof PersonOrganization) {
            return $this
                ->addUsingAlias(OrganizationPeer::ID, $personOrganization->getOrganizationId(), $comparison);
    ...
    public function filterBySession($session, $comparison = null)
    {
        if ($session instanceof Session) {
            return $this
                ->addUsingAlias(OrganizationPeer::ID, $session->getOrganizationId(), $comparison);
